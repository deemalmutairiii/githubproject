...
def get_filters():
    ...
    while True:
        ...
        if choice == 'month':
            month = input(
                "Please enter the month you want to explore. If you do not want a month filter enter 'all'. "
            ...
            day = input(
                "Please enter the day of the week you want to explore. If you do not want to apply a month filter "
                "enter 'all'. \nChoices: All, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, "
                "Saturday\n").lower()  # PB
            month = 'all'
            if day in days:
                break
...
def load_data(city, month, day):
    """
    data for the city and filters by month and day if applicable.
    Args:
